...
var author$project$Main$initSetting = {borderColor: 'black', borderStyle: 'solid 1px', height: '10', panelPosition: author$project$Main$initPanelPosition, width: '10'};
												...
												[
													...
													_List_fromArray(
														[
															...
															A3(author$project$Main$ChangeColor, y, x, 'white'))
														]),
													_List_Nil)
												]));
									},
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ChangeColor":["Basics.Int","Basics.Int","String.String"],"ColorValue":["String.String"],"AddColorToPalette":["String.String"],"SetMainPalette":["Basics.Int"],"DeleteSubPalette":["Basics.Int"],"SetCampusWidth":["String.String"],"SetCampusHeight":["String.String"],"CreateCampus":[],"ForDisabled":[],"ShowModal":[],"CloseModal":[],"BorderColorValue":["String.String"],"Change":["String.String"],"ChangePixelSize":["String.String","String.String"],"SetPixelWidth":["String.String"],"SetPixelHeight":["String.String"],"CreateCampusPicture":[],"DisplayDlButton":[],"ChangePanelPosition":["Main.Panel","Main.Position"],"ApplySetting":[]}},"Main.Panel":{"args":[],"tags":{"SettingPanel":[],"PalettePanel":[]}},"Main.Position":{"args":[],"tags":{"Right":[],"Left":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));